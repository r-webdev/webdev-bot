...
import { type Command, predicate as commandPredicate } from '../commands';
import { type DiscordEvent, predicate as eventPredicate } from '../events';
...
export const loadStructures = async <T>(
	...
	for (const file of files) {
		...
		// If the structure is valid, add it to the array
...
export const getCommands = async (
	...
	const commands = await loadStructures<Command>(
		dir,
		commandPredicate,
		recursive,
	);

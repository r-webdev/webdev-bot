...
export const modalSubmitInteractions = new Map<string, ModalSubmitInteraction>();
...
export const handleModalInteraction = async (interaction: ModalInteraction): Promise<void> => {
